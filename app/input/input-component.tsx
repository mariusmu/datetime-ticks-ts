        ...
        return (
            <div>
                ...
                <CenteredDiv>
                    ...
                    <OutputComponent icon={svgAtom} text={this.state.jsTick} desc="To string" converter={convertToString} />
                    <OutputComponent icon={svgJs} text={this.state.jsTick} desc="JS-Tick" converter={convertToJsTick} />
                    <OutputComponent icon={svgVisualStudio} text={this.state.jsTick} desc="dotnet-Tick" converter={convertToCsharpTick} />
                </CenteredDiv>
            </div>
        );
    }
